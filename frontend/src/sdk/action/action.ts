...
export type Action = EraseLayersAction | GotoAndPlayAction
  | PlayAction | StopAction | SetTextValueAction
  | ExecuteScriptAction | CallComponentUserFunctionAction
  | StartUserTimerAction | ClearUserTimerAction
  | RegisterGlobalKeydownListenerAction | UnregisterGlobalKeydownListenerAction;
