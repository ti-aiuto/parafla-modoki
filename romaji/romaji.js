...
function convertToRomaji(_, args) {
...
console.log(convertToRomaji(null, {word: "しんねん"}));
console.log(convertToRomaji(null, {word: "しんにゅう"}));
console.log(convertToRomaji(null, {word: "ししゃ"}));
console.log(convertToRomaji(null, {word: "しんしゃ"}));
console.log(convertToRomaji(null, {word: "たっせい"}));
console.log(convertToRomaji(null, {word: "じっしゃ"}));
console.log(convertToRomaji(null, {word: "しゃちょう"}));
console.log(convertToRomaji(null, {word: "しゃしん"}));
console.log(convertToRomaji(null, {word: "からばっじょ"}));
